...
export function IndustryCta({
  ...
  return (
    <section className="relative w-full bg-[#070709] text-white pt-24 sm:pt-36 pb-20 sm:pb-28 overflow-hidden border-t border-white/10">
      {/* Atmospheric Silhouette & Ambient Emerald/Cyan Glow */}
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <div className="h-[450px] w-[750px] rounded-full bg-radial from-emerald-600/15 via-teal-500/5 to-transparent blur-3xl opacity-60" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-[1560px] px-6 sm:px-10 lg:px-16 xl:px-20 text-center flex flex-col items-center">
        ...
        <h2 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight uppercase leading-[0.94] max-w-5xl flex flex-wrap justify-center gap-x-4 sm:gap-x-6">
          ...
          <motion.span
            ...
            className="inline-block bg-gradient-to-r from-white via-emerald-200 to-teal-300 bg-clip-text text-transparent"
          >
            NEXT.
          </motion.span>
        </h2>
        ...
        >
          ...
          >
            <span>Talk to Financial Engineering</span>
          ...
          >
            ...
            <Sparkles className="h-4 w-4 text-emerald-300 opacity-70 transition-all duration-200 group-hover:opacity-100 group-hover:scale-110" />
          </Link>
        </motion.div>
      </div>
    </section>
