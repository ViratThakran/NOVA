...
export function CtaSection() {
  ...
  return (
    <section className="relative w-full bg-[#070709] text-white pt-24 sm:pt-36 pb-20 sm:pb-28 overflow-hidden">
      {/* 14 & 17 — ATMOSPHERIC SILHOUETTE & AMBIENT HORIZONTAL GLOW */}
      ...
      <div className="relative z-10 mx-auto max-w-[1560px] px-6 sm:px-10 lg:px-16 xl:px-20 text-center flex flex-col items-center">
        ...
        {/* 17 — HORIZONTAL CONVERGENCE STATEMENT ("LET'S BUILD WHAT'S NEXT.") */}
        ...
        >
          Join thousands of engineers, student squads, and partner labs building production-grade software, AI systems, and career pathways.
        </motion.p>
