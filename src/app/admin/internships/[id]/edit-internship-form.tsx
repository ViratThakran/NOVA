...
export function EditInternshipForm({ internship }: { internship: InternshipContent }) {
  const [state, formAction, pending] = useActionState(updateInternshipAction, initialAdminActionState);
