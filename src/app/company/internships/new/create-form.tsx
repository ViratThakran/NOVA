...
import { createCompanyInternshipAction } from "../../actions";
...
export function CreateCompanyInternshipForm({ companyId }: { companyId: string }) {
  const [state, formAction, pending] = useActionState(createCompanyInternshipAction, initialCompanyActionState);
