...
export const metadata: Metadata = {
  title: "Responsible Technology | Who We Are",
  description:
    "Discover NOVA's commitment to ethical AI deployment, transparent algorithms, data privacy, and robust security governance.",
};

const GOVERNANCE_PRINCIPLES = [
  {
    num: "01",
    title: "Transparent AI & Determinism",
    description:
      "We design AI systems with inspectable decision paths, human-in-the-loop approvals, and verifiable execution trails.",
  },
  {
    num: "02",
    title: "Uncompromising Data Privacy",
    description:
      "User data and candidate code repositories are protected with strict access controls, zero unauthorized data sharing, and robust encryption.",
  },
  {
    num: "03",
    title: "Open Auditability & Governance",
    description:
      "Our learning environments and enterprise solutions adhere to open governance frameworks, ensuring complete auditability.",
  },
  {
    num: "04",
    title: "Human Agency & Mentorship",
    description:
      "Artificial intelligence augments human engineering capability — it never replaces peer collaboration, critical thinking, or senior mentorship.",
  },
];

export default function ResponsibleTechnologyPage() {
  return (
    <div className="min-h-screen bg-white text-neutral-950 selection:bg-indigo-600 selection:text-white">
      ...
      <main className="flex flex-col">
        ...
        <section
          data-chapter="01 / RESPONSIBLE TECH"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-5 relative aspect-[4/3] rounded-3xl overflow-hidden border border-white/15 shadow-2xl">
                <Image
                  ...
                  alt="Responsible Technology & AI Governance"
                  fill
                  priority
        ...
        {/* 02 — PRINCIPLE-BASED STORYTELLING (Light #F8F9FC) */}
        <section
          data-chapter="02 / ETHICAL FOUNDATIONS"
          ...
          <div className="mx-auto w-full max-w-[1560px] px-6 sm:px-10 lg:px-16 xl:px-20 flex flex-col gap-12">
            <div className="max-w-4xl flex flex-col gap-6">
              ...
              <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-neutral-950 uppercase leading-tight">
                &ldquo;TECHNOLOGY MUST ALWAYS SERVE HUMAN CAPABILITY AND DIGNITY.&rdquo;
              </h2>
              <p className="text-base sm:text-lg text-neutral-700 font-normal leading-relaxed">
                As artificial intelligence and automated orchestration pipelines become more prevalent, NOVA remains committed to building technology that is transparent, deterministic, and ethically aligned.
              </p>
            </div>
          </div>
        </section>

        {/* 03 — GOVERNANCE FRAMEWORK (Dark #0A0A0E) */}
        <section
          data-chapter="03 / GOVERNANCE FRAMEWORK"
              ...
              {GOVERNANCE_PRINCIPLES.map((gp) => (
                ...
                >
                  <div className="flex flex-col gap-3">
                    <span className="font-mono text-xs font-bold text-indigo-400">{gp.num}</span>
                    <h3 className="text-xl font-bold text-white tracking-tight">{gp.title}</h3>
