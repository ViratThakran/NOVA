...
// of a plain service-request/task RPC call, which this file never expects
// and never asserts on. Matches the same guard already used in
// ai-engine.test.ts / ai-orchestration.test.ts / ai-workflow.test.ts.
